...
**Current ROAR data scale (as of February 2026):**
...
-   State privacy laws vary and are reviewed for each partnership to ensure full compliance
...
Data sharing approach balances open science principles with legal and ethical obligations.

Data Use Agreements with educational partners:

-   Specify approved research purposes and security requirements

-   Protect student and school privacy as required by FERPA

-   May limit redisclosure to protect partner confidentiality

-   Are negotiated to permit maximum appropriate sharing

When direct data sharing is not feasible, we support reproducibility through:

-   Sharing aggregated or deidentified data when permitted

-   Providing synthetic datasets that maintain statistical properties

-   Making all analysis code publicly available

-   Offering controlled access to qualified researchers

-   Comprehensive documentation of methods and measures"
...
-   Consent procedures follow IRB-approved protocols appropriate to minimal-risk educational research
...
-   Request access from Director of Technology and Innovation
...
4.  Request access from Data Manager/Scientist or team lead
...
### Special security consideration for AI tools {#sec-dmp-data-security-ai}
...
### Incident response and breach reporting {#sec-dmp-data-security-incident-response}
...
-   PI (Jason Yeatman) and Data Manager/Scientist review DMP for accuracy and completeness
...
-   Major personnel changes (PI, Data Manager/Scientist departure)
...
**Primary responsibility:** PI (Jason Yeatman) and Data Manager/Scientist

**Process:**

1.  Data Manager/Scientist proposes updates based on operational needs

2.  PI (Jason Yeatman) reviews and approves

3.  Relevant team leads consulted if changes affect their areas

4.  Updated DMP distributed to team

5.  Notifications sent to external stakeholders as needed

### xIntegration with project management
...
The PI, Data Manager/Scientist, and/or team leads will monitor DMP implementation through:
