...
If you observe or suspect research misconduct, report it immediately to the Principal Investigator (Jason Yeatman).
...
-   If you plan to work outside of the United States, please consult with your team lead and PI to discuss [data security and procedures](https://global.stanford.edu/plan-your-global-activity/hr-and-employment/stanford-personnel-working-abroad)

**Using AI tools with research data:**

-   Complete Stanford's AI Assessment before using AI tools with any research data

-   Never upload identifiable student data to AI chat interfaces

-   Assume AI tools are NOT approved for identifiable data unless explicitly verified

-   See @sec-dmp-data-security-ai for detailed AI tool guidelines
...
-   Report any data breaches immediately to:

    -   Principal Investigator

    -   Stanford IT Security (security\@stanford.edu)

    -   IRB (within 5 business days)

    -   See @sec-dmp-data-security-incident-response for full incident response procedures
...
-   If you need access to specific folders or datasets, contact the Director of Research and Partnerships or the PI
...
-   Fill out a project management document for any new projects/analyses (see @sec-dmp-project-management-doc for more information and a project management template)
...
-   Make code public upon publication (or earlier if appropriate) after consulting with the PI
...
-   Discuss data sharing plans with the PI
...
-   Data Manager/Scientist (Kelly Wentzlof): R, statistics, ROAR data

-   PI (Jason Yeatman)

-   Director of Reseach and Partnerships (Carrie Townley-Flores): R, statistics, organizational data

-   Director of Technology and Innovation (Adam Richie-Halford): VS Code, ROAR development, technical infrastructure

-   Lab meetings (for broader input)

**Data management questions:**

-   Data Manager/Scientist (Kelly Wentzlof): ROAR data organization

-   Director of Reseach and Partnerships (Carrie Townley-Flores): partnerships data, DUAs

-   Director of Technology and Innovation (Adam Richie-Halford): ROAR BigQuery, development

-   Cloud Engineer (Kyle Montville): ROAR BigQuery

**IRB and ethics questions:**

-   Director of Reseach and Partnerships (Carrie Townley-Flores): partnerships team leads

-   PI (Jason Yeatman)

-   Lead Research Associate (Sarahi Muñoz) and Teacher Support Specialist (May Fahrenthold): IRB coordinators

-   Stanford IRB office

**Computing resources:**

-   Data Manager/Scientist (Kelly Wentzlof): data science

-   Director of Technology and Innovation (Adam Richie-Halford): development

-   PI (Jason Yeatman): major resource needs, cluster access
